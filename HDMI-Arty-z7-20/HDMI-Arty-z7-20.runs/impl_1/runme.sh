...
HD_PWD='C:/Users/Admin/hdmi_project/HDMI-Arty-z7-20/HDMI-Arty-z7-20.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_test.tcl -notrace
